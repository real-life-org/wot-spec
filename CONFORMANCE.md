...
- Gegen-Verifikationen nur dann als gegenseitige In-Person-Verifikation akzeptieren, wenn `inResponseTo` auf einen noch nicht abgelaufenen lokalen Pending-Counter-State verweist.
