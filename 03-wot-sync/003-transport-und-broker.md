...
| `GENERATION_GAP` | `space-rotate` mit `newGeneration > aktuelle Generation + 1` — der Absender ist gegenüber dem Broker-Zustand vorausgeeilt bzw. hat Rotationen verpasst; er MUSS per Catch-Up aktualisieren und neu stagen |
