...
Die Quick Wins (inklusive deterministische Nonce-Konstruktion) sind bereits in der Spec (18.04.2026). Damit ist v1.0 auf "Community-Tool sicher" Niveau.

**Für "nicht-trivial-secure" (gegen casual attackers):**
M6 (Device-TTL), S3 (Split-Brain), M4 (Rate-Limiting), K3 (Admin Metadata), K1 (Multi-Admin) — **~5-7 Wochen**.
...
**Phase 1 (erledigt, 18.04.2026):** Quick Wins inklusive K2 (deterministische Nonce). Spec ist auf "Community-Tool sicher" Niveau.

**Phase 2 (nächste 2-3 Monate):** Multi-Admin + Device-TTL + Split-Brain-Detection + Admin-only Metadata. Damit "für ernste Projekte sicher" Niveau — vergleichbar mit Matrix, Signal (ohne deren Forward Secrecy).
