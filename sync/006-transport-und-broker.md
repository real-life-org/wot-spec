...
Die Signatur wird gemäß [Core 002](../core/002-signaturen-und-verifikation.md) erstellt — JCS-kanonisiert, SHA-256 gehasht, Ed25519 signiert. Sie deckt alle Felder außer `sig` selbst ab.
