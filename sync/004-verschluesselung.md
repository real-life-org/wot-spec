...
Aus dem Master-Seed (siehe [Core 001](../core/001-identitaet-und-schluesselableitung.md)):
...
Wie Seed und andere sensible Daten auf dem Gerät geschützt werden ist Sache der Implementierung (siehe [Core 001](../core/001-identitaet-und-schluesselableitung.md), Abschnitt "Seed-Schutz auf dem Gerät").
